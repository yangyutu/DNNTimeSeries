...
class DeepARPredictor(RNNPredictorBase):

    def __init__(self, config, net, optimizer, netLossFunc, trainDataLoader):
        super(DeepARPredictor, self).__init__(config, net, optimizer, netLossFunc, trainDataLoader)
